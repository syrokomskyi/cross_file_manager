...
This is a general style guide that shall govern over all **CrossFileManager** project. The aim is
...
- You must always use relative imports for imports within the `cross_file_manager` library
